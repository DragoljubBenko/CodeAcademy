...
class Car {
  ...
  brandType() {
    for (let i = 0; i < 500; i++)
      if (this.brand[i] < 500) {
        console.log(`${this.brand[i]} can drive only 10 years expirience.`);
      }
    if (this.brand[i] < 200) {
      console.log(`${this.brand[i]} can't drive`);
    }
  }
...
let brendNaKoli = new Car(imeNaVozac, godiniNaVozac);
brendNaKoli.brandType();
